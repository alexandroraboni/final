...
var timeSinceHit = 0;
var activeGame = true;
var defaultFont = new font.Font("40px Georgia");
...
function main() {
  ...
  function gameTick(msDuration) {
    if (activeGame) {
      ...
      display.blit(defaultFont.render("PEDRA, PAPEL OU TESOURA!", "#000000"), [300, 0]);

      display.blit(defaultFont.render("Jogador 1: ", "#ee8517"), [0, 240]);
      display.blit(defaultFont.render("  " + player1.health, "#ee8517"), [170, 240]);
      display.blit(defaultFont.render("Controles: W A S D", "#ee8517"), [0, 300]);
      display.blit(defaultFont.render("Vitória: " + localStorage.getItem("placarjogador1").length, "#ee8517"), [0, 361]);

      display.blit(defaultFont.render("Jogador 2: ", "#1432eb"), [800, 240]);
      display.blit(defaultFont.render(player2.health, "#1432eb"), [1000, 240]);
      display.blit(defaultFont.render("Controles: \u2191 \u2193 \u2190 \u2192", "#1432eb"), [800, 300]);
      display.blit(defaultFont.render("Vitória: " + localStorage.getItem("placarjogador2").length, "#1432eb"), [800, 365]);
      ...
      if (player1.health === 0 || player2.health === 0) {
        ...
        if (player1.health === 0) {
          display.blit(defaultFont.render("Jogador 1 Derrotado", "#000000"), [0, 480]);
          i = localStorage.getItem("placarjogador2")
          t = i + 1;
          localStorage.setItem("placarjogador2", t)
          localStorage.set

        }
        if (player2.health === 0) {
          display.blit(defaultFont.render("Jogador 2 Derrotado", "#000000"), [800, 480]);
          i = localStorage.getItem("placarjogador1")
          t = i + 1;
          localStorage.setItem("placarjogador1", t)
          localStorage.set
